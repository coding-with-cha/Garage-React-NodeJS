  ...
  return <div className="registerPage">
    ...
    <div className="registerForm">
      <form onSubmit={handleSubmit(userInfo)} className="formRegister">
          <input type="text" placeholder="name" {...register('name',{required: true})} className="furstInput"/>
          ...
          <input className='inputPass' type="password" placeholder="password" {...register('password',{required: true,minLength:{value:6,

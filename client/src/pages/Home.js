    ...
    <div className="home">
      <div className="WandP">
        <div className="welcomeText">
          <h1>
            Commencez <br />à vendre en ligne
          </h1>
        ...
        <div className="main">
          ...
          <div className="iphone-body">
            ...
            <div className="contenu">
              <h1 className="contenuh1">
                <img src={icon4} /> Vendez tout GRATUITEMENT
              </h1>
              <h1 className="contenuh1">
                <img src={icon4} /> Des centaines d'acheteurs chaque jour
              </h1>
              <h1 className="contenuh1">
                <img src={icon4} /> Ajoutez des photos pour vendre plus vite
              </h1>
              ...
              />
              <div className="footerIphone">
                <span>WWWW.GARAGE.COM</span>{" "}
              </div>
            </div>
            <div className="tt">
              <div className="time">
      ...
      <div className="bodyHome">
        <div className="homeSection1">
          ...
          <div className="wrapper">
            <Link to="/Clothing" className="item">
              <div>
                <img src={clothing} />
                <div className="text">
                  <h1>Vêtements</h1>
            ...
            <Link to="/Electro" className="item">
              <div>
                <img src={electromenager} />
                <div className="text">
            ...
            <Link to="/Hardware" className="item">
              <div>
                <img src={hardware} />
                <div className="text">
                  <h1>Informatique</h1>
        ...
        <div className="homeSection1-2">
          <div>
            <h1>
              Avoir une passion c'est bien ! <br />
              La partager avec les autres, v'est mieux !
            </h1>
            <h2>
              Jardinage, mode, vélo... Ils sont nombreux à en parler sur
              <br />
              la Communauté GARAGE ! Rejoignez-les !
            </h2>
            <Link to="/Login" className="annonceLink">
              Rejoignez nous
            </Link>
          </div>
          <img src={meeting} />
        ...
        <div className="homeSection2">
          <p>
            Avec Garage, trouvez la bonne affaire sur le site référent de
            petites annonces de particulier à particulier et de professionnels.
            Avec des millions de petites annonces, trouvez la bonne occasion
            dans nos catégories{" "}
            <Link to="/Car" className="link">
              voiture
            </Link>
            ,{" "}
            <Link to="/Immo" className="link">
              immobilier
            </Link>
            ,{" "}
            ...
            services. Achetez en toute sécurité avec notre système de paiement
            en ligne et de livraison pour les annonces éligibles.
          </p>
        </div>
        <div className="footer">
          <ButtonMailto
            label="Écrivez-nous un e-mail"
            mailto="mailto:chaimamejbri@gmail.com"
          />
          <hr />
          <div className="bas">
            <p>GARAGE 2022</p>
